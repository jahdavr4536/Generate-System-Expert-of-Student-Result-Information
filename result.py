...
class resultClass:
    def __init__(self,root):
        ...
        #********* title *********
        title = Label(self.root,text="Add Student Result's",font = ("goudy old style",20,"bold"),bg="orange",fg="#262626").place(x=15,y=15,width=1180,height=50)
        ...
        lbl_marks_ob=Label(self.root,text="Obtained Marks",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=280)
        ...
        txt_marks=Entry(self.root,textvariable=self.var_marks,font=("goudy old style",20),bg="lightyellow").place(x=280,y=280,width=320)
