...
class CourseClass:
    def __init__(self,root):
        ...
        #********* title *********
        title = Label(self.root,text="Manage Course Details",font = ("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=15,y=15,width=1180,height=35)
    ...
    def delete(self):
        ...
        try:
            if self.var_course.get()=="":
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","Please select ourse from the list first..!!!",parent=self.root)
                else:
